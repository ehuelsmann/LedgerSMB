package LedgerSMB::Company::Configuration::Service;

=head1 NAME

LedgerSMB::Company::Configuration::Service - Service invoice item (non-tracking)
...
Configuration of goods and services Service (non-inventory-tracking invoice
item).
...
sub save {
    ...
    my ($row) = $self->call_dbmethod(funcname => 'parts__save_service');
