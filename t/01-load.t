...
my @modules =
    (
     ...
     'LedgerSMB::Company::Configuration::Overhead',
     'LedgerSMB::Company::Configuration::Part',
     'LedgerSMB::Company::Configuration::Parts',
     'LedgerSMB::Company::Configuration::Service',
