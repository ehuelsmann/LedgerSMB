...
define("dojo/NodeList-data", ["./_base/kernel", "./query", "./_base/lang", "./_base/array", "./dom-attr"], function(c, h, k, m, l) {
  var e = h.NodeList, d = {}, n = 0, g = function(b) {
    ...
    var c = g(b);
    d[c] && (a ? delete d[c][a] : delete d[c])
  };
  e._gcNodeData = c._gcNodeData = function() {
    var b = h("[data-dojo-dataid]").map(g), a;
    for(a in d) {
      0 > m.indexOf(b, a) && delete d[a]
    }
  };
  k.extend(e, {data:e._adaptWithCondition(p, function(b) {
