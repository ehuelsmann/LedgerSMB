//>>built
define("dojo/cookie", ["./_base/kernel", "./regexp"], function(c, h) {
  c.cookie = function(c, f, b) {
    var a = document.cookie, e;
    if(1 == arguments.length) {
      e = (e = a.match(RegExp("(?:^|; )" + h.escapeString(c) + "\x3d([^;]*)"))) ? decodeURIComponent(e[1]) : void 0
    }else {
      b = b || {};
      a = b.expires;
      if("number" == typeof a) {
      ...
      a && a.toUTCString && (b.expires = a.toUTCString());
      f = encodeURIComponent(f);
      var a = c + "\x3d" + f, g;
      for(g in b) {
        a += "; " + g, d = b[g], !0 !== d && (a += "\x3d" + d)
      }
      document.cookie = a
    }
    return e
