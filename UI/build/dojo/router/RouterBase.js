...
define("dojo/router/RouterBase", ["dojo/_base/declare", "dojo/hash", "dojo/topic"], function(q, n, r) {
  ...
  return q(null, {_routes:null, _routeIndex:null, _started:!1, _currentPath:"", idMatch:/:(\w[\w\d]*)/g, idReplacement:"([^\\/]+)", globMatch:/\*(\w[\w\d]*)/, globReplacement:"(.+)", constructor:function(a) {
    this._routes = [];
    this._routeIndex = {};
    for(var b in a) {
    ...
    a = p(a);
    (c = this._handlePathChange(a)) && n(a, b);
    return c
  }, startup:function(a) {
    if(!this._started) {
      var b = this, c = n();
    ...
    var b, c, d, e, f, g, h, k, l = this._routes, m = this._currentPath;
    if(!this._started || a === m) {
      return c
    }
    c = !0;
    b = 0;
    for(d = l.length;b < d;++b) {
      if(f = l[b], g = f.route.exec(a)) {
        if(f.parameterNames) {
          h = f.parameterNames;
          k = {};
          c = 0;
    ...
    var b = this.idMatch, c = this.globMatch, d = [], e;
    for(b.lastIndex = 0;null !== (e = b.exec(a));) {
      d.push(e[1])
    }
    ...
    var d, e, f, g, h, k = this, l = this._routes, m = this._routeIndex;
    d = this._routeIndex[a];
    (e = "undefined" !== typeof d) && (f = l[d]);
    f || (f = {route:a, callbackQueue:[], fire:s});
    g = f.callbackQueue;
