...
define("dojo/request/watch", "./util ../errors/RequestTimeoutError ../errors/CancelError ../_base/array ../_base/window ../has!host-browser?dom-addeventlistener?:../on:".split(" "), function(q, l, m, n, e, h) {
  function k() {
    for(var p = +new Date, d = 0, b;d < c.length && (b = c[d]);d++) {
      ...
      if(b.isCanceled && b.isCanceled() || b.isValid && !b.isValid(f)) {
        c.splice(d--, 1), a._onAction && a._onAction()
      }else {
        if(b.isReady && b.isReady(f)) {
          c.splice(d--, 1), b.handleResponse(f), a._onAction && a._onAction()
        }else {
          if(b.startTime && b.startTime + (e.timeout || 0) < p) {
            c.splice(d--, 1), b.cancel(new l("Timeout exceeded", f)), a._onAction && a._onAction()
          }
        }
      }
    }
