//>>built
define("dojo/request/util", "exports ../errors/RequestError ../errors/CancelError ../Deferred ../io-query ../_base/array ../_base/lang ../promise/Promise".split(" "), function(f, q, m, r, n, s, h, t) {
  function u(b) {
    return p(b)
  }
  function v(b) {
    return b.data || b.text
  }
  ...
  f.deferred = function(b, c, e, d, a, k) {
    var g = new r(function(a) {
      c && c(g, b);
      return!a || !(a instanceof q) && !(a instanceof m) ? new m("Request canceled", b) : a
    });
    g.response = b;
    g.isValid = e;
    g.isReady = d;
    g.handleResponse = a;
    e = g.then(u).otherwise(function(a) {
      a.response = b;
      throw a;
    });
  ...
  f.addCommonMethods = function(b, c) {
    s.forEach(c || ["GET", "POST", "PUT", "DELETE"], function(c) {
  ...
  f.parseArgs = function(b, c, e) {
    ...
    d && !e && "object" === typeof d && (c.data = n.objectToQuery(d));
