//>>built
define("dojo/request/xhr", ["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], function(n, x, p, e, c) {
  function y(a, b) {
    var d = a.xhr;
    ...
    b ? this.reject(b) : e.checkStatus(d.status) ? this.resolve(a) : (b = new n("Unable to load " + a.url + " status: " + d.status, a), this.reject(b))
  }
  function z(a) {
    return this.xhr.getResponseHeader(a)
  }
  function k(a, b, d) {
    var u = c("native-formdata") && b && b.data && b.data instanceof FormData, f = e.parseArgs(a, e.deepCreate(A, b), u);
    a = f.url;
    b = f.options;
    var q, h = e.deferred(f, r, s, v, y, function() {
      q && q()
    }), g = f.xhr = k._create();
    if(!g) {
      return h.cancel(new n("XHR was not created")), d ? h : h.promise
    }
    f.getHeader = z;
    t && (q = t(g, h, f));
    var p = b.data, B = !b.sync, C = b.method;
    try {
      g.open(C, a, B, b.user || void 0, b.password || void 0);
      b.withCredentials && (g.withCredentials = b.withCredentials);
      c("native-response-type") && b.handleAs in w && (g.responseType = w[b.handleAs]);
      var l = b.headers;
      a = u ? !1 : "application/x-www-form-urlencoded";
      if(l) {
        for(var m in l) {
          "content-type" === m.toLowerCase() ? a = l[m] : l[m] && g.setRequestHeader(m, l[m])
        }
      }
  ...
  var w = {blob:c("native-xhr2-blob") ? "blob" : "arraybuffer", document:"document", arraybuffer:"arraybuffer"}, s, v, t, r;
  c("native-xhr2") ? (s = function(a) {
    ...
    function f(a) {
      a = new n("Unable to load " + d.url + " status: " + a.target.status, d);
      b.handleResponse(d, a)
    }
    function e(a) {
      a.lengthComputable ? (d.loaded = a.loaded, d.total = a.total, b.progress(d)) : 3 === d.xhr.readyState && (d.loaded = a.position, b.progress(d))
    }
    ...
    var c = b.xhr, e = typeof c.abort;
    ("function" === e || "object" === e || "unknown" === e) && c.abort()
  });
  var A = {data:null, query:null, sync:!1, method:"GET"};
  k._create = function() {
