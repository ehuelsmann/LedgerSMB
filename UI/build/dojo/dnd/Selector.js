//>>built
define("dojo/dnd/Selector", "../_base/array ../_base/declare ../_base/kernel ../_base/lang ../dom ../dom-construct ../mouse ../_base/NodeList ../on ../touch ./common ./Container".split(" "), function(n, p, q, k, f, r, s, t, l, m, e, u) {
  var h = p("dojo.dnd.Selector", u, {constructor:function(b, a) {
    a || (a = {});
    ...
    if(this.current) {
      if(!this.singular && !e.getCopyKeyState(b) && !b.shiftKey && this.current.id in this.selection) {
        this.simpleSelection = !0, s.isLeft(b) && (b.stopPropagation(), b.preventDefault())
      }else {
