//>>built
define("dojo/on", ["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./sniff"], function(w, x, e) {
  function y(a, b, c, d, g) {
    if(d = b.match(/(.*):(.*)/)) {
      return b = d[2], d = d[1], f.selector(d, b).call(g, a, c)
    }
    e("touch") && (z.test(b) && (c = n(c)), !e("event-orientationchange") && "orientationchange" == b && (b = "resize", a = window, c = n(c)));
    p && (c = p(c));
    if(a.addEventListener) {
      var k = b in q, m = k ? q[b] : b;
      a.addEventListener(m, c, k);
      return{remove:function() {
        a.removeEventListener(m, c, k)
      }}
    }
    if(r && a.attachEvent) {
      return r(a, "on" + b, c)
  ...
  e.add("jscript", s && s() + ScriptEngineMinorVersion() / 10);
  ...
  var f = function(a, b, c, d) {
    return"function" == typeof a.on && "function" != typeof b && !a.nodeType ? a.on(b, c) : f.parse(a, b, c, y, d, this)
  };
  ...
  f.once = function(a, b, c, d) {
    var g = f(a, b, function() {
      g.remove();
      return c.apply(this, arguments)
    });
    return g
  };
  f.parse = function(a, b, c, d, g, k) {
    if(b.call) {
      return b.call(k, a, c)
    }
  ...
  var z = /^touch/;
  f.matches = function(a, b, c, d, g) {
    g = g && g.matches ? g : x.query;
    d = !1 !== d;
  ...
  f.selector = function(a, b, c) {
    return function(d, g) {
      function e(b) {
        return f.matches(b, a, d, c, m)
      }
      var m = "function" == typeof a ? {matches:a} : this, h = b.bubble;
      return h ? f(d, h(e), g) : f(d, b, function(a) {
        var b = e(a.target);
        if(b) {
          return g.call(b, a)
        }
  ...
  var C = [].slice, D = f.emit = function(a, b, c) {
    var d = C.call(arguments, 2), g = "on" + b;
    if("parentNode" in a) {
      var e = d[0] = {}, f;
      for(f in c) {
        e[f] = c[f]
    ...
    do {
      a[g] && a[g].apply(a, d)
    }while(c && c.bubbles && (a = a.parentNode));
    return c && c.cancelable && c
  }, q = e("event-focusin") ? {} : {focusin:"focus", focusout:"blur"};
    ...
    var E = function() {
      ...
      return function(b) {
        if(!b.immediatelyStopped) {
          return b.stopImmediatePropagation = E, a.apply(this, arguments)
        }
      }
    }
  }
  if(e("dom-addeventlistener")) {
    ...
    f._fixEvent = function(a, b) {
      ...
      try {
        h && (a.type == h.type && a.srcElement == h.target) && (a = h)
      }catch(c) {
      }
      if(!a.target) {
        switch(a.target = a.srcElement, a.currentTarget = b || a.srcElement, "mouseover" == a.type && (a.relatedTarget = a.fromElement), "mouseout" == a.type && (a.relatedTarget = a.toElement), a.stopPropagation || (a.stopPropagation = F, a.preventDefault = G), a.type) {
          case "keypress":
    ...
    var H = function(a) {
      return function(b) {
        ...
        var c = a.call(this, b);
        b.modified && (h || setTimeout(function() {
          h = null
        }), h = b);
        return c
      }
      ...
      return w.after(a, b, c, !0)
    }, F = function() {
      this.cancelBubble = !0
    }, G = f._preventDefault = function() {
  ...
  if(e("touch")) {
    var u = function() {
    }, v = window.orientation, n = function(a) {
      return function(b) {
        var c = b.corrected;
        if(!c) {
          var d = b.type;
