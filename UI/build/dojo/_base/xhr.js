//>>built
define("dojo/_base/xhr", "./kernel ./sniff require ../io-query ../dom ../dom-form ./Deferred ./config ./json ./lang ./array ../on ../aspect ../request/watch ../request/xhr ../request/util".split(" "), function(b, r, F, p, y, l, z, G, u, n, A, H, v, m, w, B) {
  b._xhrObj = w._create;
  var s = b.config;
  b.objectToQuery = p.objectToQuery;
  b.queryToObject = p.queryToObject;
  b.fieldToObject = l.fieldToObject;
  b.formToObject = l.toObject;
  b.formToQuery = l.toQuery;
  b.formToJson = l.toJson;
  b._blockAsync = !1;
  var q = b._contentHandlers = b.contentHandlers = {text:function(a) {
  ...
  b._ioSetArgs = function(a, d, f, C) {
    ...
    c.query = p.objectToQuery(n.mixin.apply(null, h));
    ...
    k.addCallback(f);
    var t = a.load;
    t && n.isFunction(t) && k.addCallback(function(b) {
      return t.call(a, b, c)
    });
    var e = a.error;
    e && n.isFunction(e) && k.addErrback(function(b) {
      return e.call(a, b, c)
    });
    var m = a.handle;
    m && n.isFunction(m) && k.addBoth(function(b) {
      return m.call(a, b, c)
    });
    k.addErrback(function(a) {
      return C(a, k)
    });
    s.ioPublish && (b.publish && !1 !== c.args.ioPublish) && (k.addCallbacks(function(a) {
  ...
  var D = function(a) {
    ...
    0 >= e && (e = 0, s.ioPublish && (b.publish && (!a || a && !1 !== a.ioArgs.args.ioPublish)) && b.publish("/dojo/io/stop"))
  }, e = 0;
  ...
  b._ioNotifyStart = function(a) {
    s.ioPublish && (b.publish && !1 !== a.ioArgs.args.ioPublish) && (e || b.publish("/dojo/io/start"), e += 1, b.publish("/dojo/io/send", [a]))
  };
  b._ioWatch = function(a, b, f, e) {
    a.ioArgs.options = a.ioArgs.args;
    n.mixin(a, {response:a.ioArgs, isValid:function(c) {
      return b(a)
    }, isReady:function(b) {
      return f(a)
  ...
  n.mixin(b.xhr, {_xhrObj:b._xhrObj, fieldToObject:l.fieldToObject, formToObject:l.toObject, objectToQuery:p.objectToQuery, formToQuery:l.toQuery, formToJson:l.toJson, queryToObject:p.queryToObject, contentHandlers:q, _ioSetArgs:b._ioSetArgs, _ioCancelAll:b._ioCancelAll, _ioNotifyStart:b._ioNotifyStart, _ioWatch:b._ioWatch, _ioAddQueryToUrl:b._ioAddQueryToUrl, _isDocumentOk:b._isDocumentOk, _getText:b._getText, get:b.xhrGet, post:b.xhrPost, put:b.xhrPut, del:b.xhrDelete});
  return b.xhr
});
