//>>built
define("dojo/_base/Deferred", "./kernel ../Deferred ../promise/Promise ../errors/CancelError ../has ./lang ../when".split(" "), function(c, g, y, z, u, h, A) {
  var s = function() {
    ...
    function v() {
      for(var a;!a && e;) {
        ...
        u("config-useDeferredInstrumentation") && m && g.instrumentRejected && g.instrumentRejected(l, !!d);
        if(d) {
          try {
            var n = d(l);
    ...
    var l, k, w, q, m, t, e, f = this.promise = new y;
    ...
    this.reject = this.errback = function(a) {
      m = !0;
      this.fired = q = 1;
      u("config-useDeferredInstrumentation") && g.instrumentRejected && g.instrumentRejected(a, !!e);
      p(a);
      this.results = [null, a]
    };
    ...
    f.cancel = this.cancel = function() {
      if(!k) {
        var a = c && c(x);
        k || (a instanceof Error || (a = new z(a)), a.log = !1, x.reject(a))
      }
      w = !0
    };
    B(f)
