//>>built
define("dojo/html", "./_base/kernel ./_base/lang ./_base/array ./_base/declare ./dom ./dom-construct ./parser".split(" "), function(k, g, h, l, m, f, n) {
  var p = 0, e = {_secureForInnerHtml:function(a) {
    return a.replace(/(?:\s*<!DOCTYPE\s[^>]+>|<title[^>]*>[\s\S]*?<\/title>)/ig, "")
  }, _emptyNode:f.empty, _setNodeContent:function(a, b) {
    f.empty(a);
    if(b) {
      if("string" == typeof b && (b = f.toDom(b, a.ownerDocument)), !b.nodeType && g.isArrayLike(b)) {
    ...
    return a
  }, _ContentSetter:l("dojo.html._ContentSetter", null, {node:"", content:"", id:"", cleanContent:!1, extractContent:!1, parseContent:!1, parserScope:k._scopeName, startup:!0, constructor:function(a, b) {
    g.mixin(this, a || {});
    b = this.node = m.byId(this.node || b);
    this.id || (this.id = ["Setter", b ? b.id || b.tagName : "", p++].join("_"))
  }, set:function(a, b) {
    ...
    try {
      a = e._setNodeContent(a, this.content)
    }catch(b) {
    ...
    var a = this.content;
    if(g.isString(a) && (this.cleanContent && (a = e._secureForInnerHtml(a)), this.extractContent)) {
    ...
    try {
      ...
      var c = this;
      this.parseDeferred = n.parse({rootNode:a, noStart:!this.startup, inherited:b, scope:this.parserScope}).then(function(a) {
    ...
    c ? console.error(c, b) : a && e._setNodeContent(this.node, a, !0)
  }}), set:function(a, b, c) {
    void 0 == b && (b = "");
    return c ? (new e._ContentSetter(g.mixin(c, {content:b, node:a}))).set() : e._setNodeContent(a, b, !0)
  }};
  g.setObject("dojo.html", e);
  return e
});
