//>>built
define("dojo/fx/easing", ["../_base/lang"], function(d) {
  var b = {linear:function(a) {
    return a
  }, quadIn:function(a) {
    return Math.pow(a, 2)
  }, quadOut:function(a) {
    ...
    a < 1 / 2.75 ? a = 7.5625 * Math.pow(a, 2) : a < 2 / 2.75 ? a = 7.5625 * Math.pow(a - 1.5 / 2.75, 2) + 0.75 : a < 2.5 / 2.75 ? (a -= 2.25 / 2.75, a = 7.5625 * Math.pow(a, 2) + 0.9375) : (a -= 2.625 / 2.75, a = 7.5625 * Math.pow(a, 2) + 0.984375);
    return a
  }, bounceInOut:function(a) {
    return 0.5 > a ? b.bounceIn(2 * a) / 2 : b.bounceOut(2 * a - 1) / 2 + 0.5
  }};
  d.setObject("dojo.fx.easing", b);
  return b
});
