//>>built
define("dojo/data/ItemFileReadStore", "../_base/kernel ../_base/lang ../_base/declare ../_base/array ../_base/xhr ../Evented ./util/filter ./util/simpleFetch ../date/stamp".split(" "), function(m, n, q, t, r, u, s, v, w) {
  q = q("dojo.data.ItemFileReadStore", [u], {constructor:function(a) {
    ...
    var d = void 0;
    "string" === typeof e && (d = s.patternToRegExp(e, !1));
    return this._containsValue(a, b, e, d)
  }, _containsValue:function(a, b, e, d) {
    return t.some(this.getValues(a, b), function(a) {
    ...
    if(a.query) {
      ...
      var h = {};
      for(c in a.query) {
        f = a.query[c], "string" === typeof f ? h[c] = s.patternToRegExp(f, k) : f instanceof RegExp && (h[c] = f)
      }
        ...
        if(this._loadInProgress) {
          ...
          k.addCallback(function(c) {
            try {
              ...
              d._loadFinished = !0, d._loadInProgress = !1, e(f, a)
            }
          });
    ...
    if(h = a.identifier) {
      ...
      this._features["dojo.data.api.Identity"] = h;
      for(c = 0;c < this._arrayOfAllItems.length;++c) {
