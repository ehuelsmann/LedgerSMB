...
define("dijit/Fieldset", ["dojo/_base/declare", "dojo/query!css2", "dijit/TitlePane", "dojo/text!./templates/Fieldset.html", "./a11yclick"], function(b, c, d, e) {
  return b("dijit.Fieldset", d, {baseClass:"dijitFieldset", title:"", open:!0, templateString:e, postCreate:function() {
    if(!this.title) {
      var a = c("legend", this.containerNode);
      a.length && (this.set("title", a[0].innerHTML), a[0].parentNode.removeChild(a[0]))
    }
