...
define("dijit/_WidgetBase", "require dojo/_base/array dojo/aspect dojo/_base/config dojo/_base/connect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/_base/kernel dojo/_base/lang dojo/on dojo/ready dojo/Stateful dojo/topic dojo/_base/window ./Destroyable dojo/has!dojo-bidi?./_BidiMixin ./registry".split(" "), function(q, f, x, k, y, z, r, n, s, p, A, t, m, B, g, u, C, D, E, F, G, H, e) {
  ...
  m.add("dijit-legacy-requires", !B.isAsync);
  m.add("dojo-bidi", !1);
  m("dijit-legacy-requires") && C(0, function() {
    q(["dijit/_base/manager"])
  });
  var w = {};
  k = z("dijit._WidgetBase", [D, G], {id:"", _setIdAttr:"domNode", lang:"", _setLangAttr:v("lang"), dir:"", _setDirAttr:v("dir"), "class":"", _setClassAttr:{node:"domNode", type:"class"}, _setTypeAttr:null, style:"", title:"", tooltip:"", baseClass:"", srcNodeRef:null, domNode:null, containerNode:null, ownerDocument:null, _setOwnerDocumentAttr:function(a) {
    this._set("ownerDocument", a)
  }, attributeMap:{}, _blankGif:k.blankGif || q.toUrl("dojo/resources/blank.gif"), _introspect:function() {
    ...
    this.ownerDocumentBody = F.body(this.ownerDocument);
    e.add(this);
    this.buildRendering();
    var c;
    if(this.domNode) {
    ...
    this.domNode && (a ? n.remove(this.domNode, "widgetId") : p.destroy(this.domNode), delete this.domNode);
    this.srcNodeRef && (a || p.destroy(this.srcNodeRef), delete this.srcNodeRef)
    ...
    var b = this.domNode;
    g.isObject(a) ? t.set(b, a) : b.style.cssText = b.style.cssText ? b.style.cssText + ("; " + a) : a;
    this._set("style", a)
    ...
    var c = this._onMap(a);
    return c ? x.after(this, c, b, !0) : this.own(u(this.domNode, a, b))[0]
  }, _onMap:function(a) {
    ...
    return this.own(y.connect(a, b, this, c))[0]
  }, disconnect:function(a) {
    a.remove()
  }, subscribe:function(a, b) {
    return this.own(E.subscribe(a, g.hitch(this, b)))[0]
    ...
    c && c.addChild && (!b || "number" === typeof b) ? c.addChild(this, b) : (c = c && "domNode" in c ? c.containerNode && !/after|before|replace/.test(b || "") ? c.containerNode : c.domNode : r.byId(a, this.ownerDocument), p.place(this.domNode, c, b), !this._started && (this.getParent() || {})._started && this.startup());
    return this
  }, defer:function(a, b) {
