//>>built
define("dijit/_PaletteMixin", "dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/keys dojo/_base/lang dojo/on ./_CssStateMixin ./a11yclick ./focus ./typematic".split(" "), function(p, e, f, n, q, l, r, s, t, g, u) {
  return p("dijit._PaletteMixin", s, {defaultTimeout:500, timeoutChangeRate:0.9, value:"", _selectedCell:-1, tabIndex:"0", cellClass:"dijitPaletteCell", dyeClass:null, _dyeFactory:function(a) {
    ...
    this.own(r(this.gridNode, t, l.hitch(this, "_onCellClick")));
    ...
    for(m in f) {
      this.own(u.addKeyListener(this.domNode, {keyCode:q[m], ctrlKey:!1, altKey:!1, shiftKey:!1}, this, function() {
        var a = f[m];
        return function(b) {
