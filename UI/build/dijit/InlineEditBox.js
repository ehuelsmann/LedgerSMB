...
define("dijit/InlineEditBox", "require dojo/_base/array dojo/aspect dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-style dojo/i18n dojo/_base/kernel dojo/keys dojo/_base/lang dojo/on dojo/sniff dojo/when ./a11yclick ./focus ./_Widget ./_TemplatedMixin ./_WidgetsInTemplateMixin ./_Container ./form/Button ./form/_TextBoxMixin ./form/TextBox dojo/text!./templates/InlineEditBox.html dojo/i18n!./nls/common".split(" "), function(s, l, t, m, n, e, u, h, w, p, v, c, g, q, x, 
y, r, b, k, z, D, E, A, B, C) {
  k = m("dijit._InlineEditor", [b, k, z], {templateString:C, contextRequire:s, postMixInProperties:function() {
    this.inherited(arguments);
    this.messages = w.getLocalization("dijit", "common", this.lang);
    l.forEach(["buttonSave", "buttonCancel"], function(a) {
      this[a] || (this[a] = this.messages[a])
    }, this)
  }, buildRendering:function() {
    this.inherited(arguments);
    var a = "string" == typeof this.editor ? c.getObject(this.editor) || s(this.editor) : this.editor, d = this.sourceStyle, f = "line-height:" + d.lineHeight + ";", e = h.getComputedStyle(this.domNode);
    l.forEach(["Weight", "Family", "Size", "Style"], function(a) {
      e["font" + a] != d["font" + a] && (f += "font-" + a + ":" + d["font" + a] + ";")
    }, this);
    ...
    "100%" == b ? (f += "width:100%;", this.domNode.style.display = "block") : f += "width:" + (b + (Number(b) == b ? "px" : "")) + ";";
    b = c.delegate(this.inlineEditBox.editorParams, {style:f, dir:this.dir, lang:this.lang, textDir:this.textDir});
    this.editWidget = new a(b, this.editorPlaceholder);
    this.inlineEditBox.autoSave && (this.saveButton.destroy(), this.cancelButton.destroy(), this.saveButton = this.cancelButton = null, u.destroy(this.buttonContainer))
  }, postCreate:function() {
    this.inherited(arguments);
    var a = this.editWidget;
    this.inlineEditBox.autoSave ? this.own(t.after(a, "onChange", c.hitch(this, "_onChange"), !0), g(a, "keydown", c.hitch(this, "_onKeyDown"))) : "intermediateChanges" in a && (a.set("intermediateChanges", !0), this.own(t.after(a, "onChange", c.hitch(this, "_onIntermediateChange"), !0)), this.saveButton.set("disabled", !0))
  }, startup:function() {
    ...
    this.inlineEditBox.autoSave && this.inlineEditBox.editing && (!a.altKey && !a.ctrlKey) && (a.keyCode == v.ESCAPE ? (a.stopPropagation(), a.preventDefault(), this.cancel(!0)) : a.keyCode == v.ENTER && "INPUT" == a.target.tagName && (a.stopPropagation(), a.preventDefault(), this._onChange()))
  }, _onBlur:function() {
    this.inherited(arguments);
    ...
    this.inlineEditBox.autoSave && (this.inlineEditBox.editing && this.enableSave()) && r.focus(this.inlineEditBox.displayNode)
  }, enableSave:function() {
    ...
    this.editWidget.focusNode && (r._onFocusNode(this.editWidget.focusNode), "INPUT" == this.editWidget.focusNode.tagName && this.defer(function() {
      A.selectInputText(this.editWidget.focusNode)
    }))
  }});
  b = m("dijit.InlineEditBox" + (q("dojo-bidi") ? "_NoBidi" : ""), b, {editing:!1, autoSave:!0, buttonSave:"", buttonCancel:"", renderAsHtml:!1, editor:B, editorWrapper:k, editorParams:{}, disabled:!1, onChange:function() {
  }, onCancel:function() {
  }, width:"100%", value:"", noValueIndicator:6 >= q("ie") ? "\x3cspan style\x3d'font-family: wingdings; text-decoration: underline;'\x3e\x26#160;\x26#160;\x26#160;\x26#160;\x26#x270d;\x26#160;\x26#160;\x26#160;\x26#160;\x3c/span\x3e" : "\x3cspan style\x3d'text-decoration: underline;'\x3e\x26#160;\x26#160;\x26#160;\x26#160;\x26#x270d;\x26#160;\x26#160;\x26#160;\x26#160;\x3c/span\x3e", constructor:function() {
    this.editorParams = {}
  }, postMixInProperties:function() {
    this.inherited(arguments);
    this.displayNode = this.srcNodeRef;
    this.own(g(this.displayNode, y, c.hitch(this, "_onClick")), g(this.displayNode, "mouseover, focus", c.hitch(this, "_onMouseOver")), g(this.displayNode, "mouseout, blur", c.hitch(this, "_onMouseOut")));
    this.displayNode.setAttribute("role", "button");
    this.displayNode.getAttribute("tabIndex") || this.displayNode.setAttribute("tabIndex", 0);
    !this.value && !("value" in this.params) && (this.value = c.trim(this.renderAsHtml ? this.displayNode.innerHTML : this.displayNode.innerText || this.displayNode.textContent || ""));
    ...
    a ? this.displayNode.removeAttribute("tabIndex") : this.displayNode.setAttribute("tabIndex", 0);
    ...
    if(!this.disabled && !this.editing) {
      this._set("editing", !0);
      this._savedTabIndex = n.get(this.displayNode, "tabIndex") || "0";
      if(!this.wrapperWidget) {
        var a = u.create("span", null, this.domNode, "before");
        this.wrapperWidget = new ("string" == typeof this.editorWrapper ? c.getObject(this.editorWrapper) : this.editorWrapper)({value:this.value, buttonSave:this.buttonSave, buttonCancel:this.buttonCancel, dir:this.dir, lang:this.lang, tabIndex:this._savedTabIndex, editor:this.editor, inlineEditBox:this, sourceStyle:h.getComputedStyle(this.displayNode), save:c.hitch(this, "save"), cancel:c.hitch(this, "cancel"), textDir:this.textDir}, a);
      ...
      h.set(d.domNode, {visibility:"visible"});
      n.set(this.displayNode, "tabIndex", "-1");
      var b = d.editWidget, g = this;
      x(b.onLoadDeferred, c.hitch(d, function() {
        b.set("displayedValue" in b || "_setDisplayedValueAttr" in b ? "displayedValue" : "value", g.value);
        this.defer(function() {
          d.saveButton && d.saveButton.set("disabled", "intermediateChanges" in b);
          this.focus();
    ...
    h.set(b.domNode, {visibility:"hidden"});
    ...
    this.displayNode.innerHTML = b || this.noValueIndicator;
    this._set("value", a);
  ...
  q("dojo-bidi") && (b = m("dijit.InlineEditBox", b, {_setValueAttr:function() {
    this.inherited(arguments);
