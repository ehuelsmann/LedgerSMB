//>>built
define("dijit/_MenuBase", "dojo/_base/array dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/_base/lang dojo/mouse dojo/on dojo/window ./a11yclick ./registry ./_Widget ./_CssStateMixin ./_KeyNavContainer ./_TemplatedMixin".split(" "), function(s, k, t, l, g, f, h, c, u, m, d, n, p, q, r) {
  return k("dijit._MenuBase", [n, r, q, p], {selected:null, _setSelectedAttr:function(a) {
    ...
    g.toggle(this.domNode, "dijitMenuActive", a);
    g.toggle(this.domNode, "dijitMenuPassive", !a);
    ...
    this.own(c(this.containerNode, c.selector(b, h.enter), function() {
      a.onItemHover(d.byNode(this))
    }), c(this.containerNode, c.selector(b, h.leave), function() {
      a.onItemUnhover(d.byNode(this))
    }), c(this.containerNode, c.selector(b, m), function(b) {
    ...
    if(a != this.currentPopupItem) {
      ...
      var d = a.popup;
      d.parentMenu = this;
      this.own(this._mouseoverHandle = c.once(d.domNode, "mouseover", f.hitch(this, "_onPopupHover")));
      var e = this;
    ...
    this._stopPopupTimer();
    this.currentPopupItem && (this.focused && (l.set(this.selected.focusNode, "tabIndex", this.tabIndex), this.selected.focusNode.focus()), this.currentPopupItem._closePopup(), this.currentPopupItem = null)
