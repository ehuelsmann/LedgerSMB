//>>built
define("dijit/layout/_ContentPaneResizeMixin", "dojo/_base/array dojo/_base/declare dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/_base/lang dojo/query ../registry ../Viewport ./utils".split(" "), function(p, h, g, e, q, f, k, l, m, n) {
  return h("dijit.layout._ContentPaneResizeMixin", null, {doLayout:!0, isLayoutContainer:!0, startup:function() {
    if(!this._started) {
      ...
      this._childOfLayoutWidget || this.own(m.on("resize", f.hitch(this, "resize")))
    }
    ...
    if(this.doLayout) {
      ...
      g.toggle(this.containerNode, this.baseClass + "SingleChild", !!this._singleChild)
    }
  }, resize:function(a, b) {
    ...
    if(c === this.domNode) {
      ...
      f.mixin(d, a || {});
      if(!("h" in d) || !("w" in d)) {
        d = f.mixin(e.getMarginBox(c), d)
      }
      this._contentBox = n.marginBox2contentBox(c, d)
    }else {
      this._contentBox = e.getContentBox(c)
    }
    ...
    return"none" != a.style.display && "hidden" != a.style.visibility && !g.contains(a, "dijitHidden") && b && b.style && "none" != b.style.display
  }, _onShow:function() {
    this._wasShown = !0;
