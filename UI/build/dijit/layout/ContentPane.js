//>>built
define("dijit/layout/ContentPane", "dojo/_base/kernel dojo/_base/lang ../_Widget ../_Container ./_ContentPaneResizeMixin dojo/string dojo/html dojo/i18n!../nls/loading dojo/_base/array dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-construct dojo/_base/xhr dojo/i18n dojo/when".split(" "), function(g, b, m, n, p, k, l, w, e, q, h, r, x, s, t, u, v) {
  ...
  baseClass:"dijitContentPane", ioArgs:{}, onLoadDeferred:null, _setTitleAttr:null, stopParser:!0, template:!1, markupFactory:function(a, d, c) {
    ...
    var a = u.getLocalization("dijit", "loading", this.lang);
    ...
    var c = this._xhrDfd = (this.ioMethod || t.get)(d), f;
    c.then(function(c) {
      f = c;
      try {
    ...
    return v(f && f.then ? f : c.parseDeferred, function() {
