...
define("dijit/form/_ListBase", ["dojo/_base/declare", "dojo/on", "dojo/window"], function(e, d, f) {
  return e("dijit.form._ListBase", null, {selected:null, _listConnect:function(a, c) {
    var b = this;
    ...
    for(var a = this.containerNode.firstChild;a && "none" == a.style.display;) {
      a = a.nextSibling
    }
    this._setSelectedAttr(a, !0)
  }, selectLastNode:function() {
    for(var a = this.containerNode.lastChild;a && "none" == a.style.display;) {
      a = a.previousSibling
    }
    this._setSelectedAttr(a, !0)
    ...
    var a = this.selected;
    if(a) {
      for(a = a.nextSibling;a && "none" == a.style.display;) {
        a = a.nextSibling
      }
    ...
    var a = this.selected;
    if(a) {
      for(a = a.previousSibling;a && "none" == a.style.display;) {
        a = a.previousSibling
      }
