...
define("dijit/form/_ComboBoxMenuMixin", "dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/has dojo/i18n dojo/i18n!./nls/ComboBox".split(" "), function(k, g, e, h, l) {
  var f = g("dijit.form._ComboBoxMenuMixin" + (h("dojo-bidi") ? "_NoBidi" : ""), null, {_messages:null, postMixInProperties:function() {
    ...
    if(a == this.previousButton) {
      this._setSelectedAttr(null), this.onPage(-1)
    }else {
      if(a == this.nextButton) {
        this._setSelectedAttr(null), this.onPage(1)
      }else {
        this.onChange(a)
      }
    ...
    var d = this._createMenuItem(), c = b(a);
    ...
    var c = !1;
    a.total && !a.total.then && -1 != a.total ? b.start + b.count < a.total ? c = !0 : b.start + b.count > a.total && b.count == a.length && (c = !0) : b.count == a.length && (c = !0);
    this.nextButton.style.display = c ? "" : "none";
    e.set(this.nextButton, "id", this.id + "_next")
  }, clearResultList:function() {
    for(var a = this.containerNode;2 < a.childNodes.length;) {
      a.removeChild(a.childNodes[a.childNodes.length - 2])
    }
    this._setSelectedAttr(null)
  ...
  h("dojo-bidi") && (f = g("dijit.form._ComboBoxMenuMixin", f, {_createOption:function() {
