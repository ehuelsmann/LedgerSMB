//>>built
define("dijit/form/_TextBoxMixin", "dojo/_base/array dojo/_base/declare dojo/dom dojo/has dojo/keys dojo/_base/lang dojo/on ../main".split(" "), function(p, k, n, l, b, g, h, m) {
  var e = k("dijit.form._TextBoxMixin" + (l("dojo-bidi") ? "_NoBidi" : ""), null, {trim:!1, uppercase:!1, lowercase:!1, propercase:!1, maxLength:"", selectOnClick:!1, placeHolder:"", _getValueAttr:function() {
    return this.parse(this.get("displayedValue"), this.constraints)
  }, _setValueAttr:function(a, c, b) {
    var d;
    void 0 !== a && (d = this.filter(a), "string" != typeof b && (b = null !== d && ("number" != typeof d || !isNaN(d)) ? this.filter(this.format(d, this.constraints)) : "", 0 != this.compare(d, this.filter(this.parse(b, this.constraints))) && (b = null)));
    ...
    this.own(h(this.textbox, "keydown, keypress, paste, cut, input, compositionend", g.hitch(this, function(a) {
      ...
      if("keydown" == a.type) {
        ...
        if(!a.ctrlKey && !a.metaKey && !a.altKey) {
          ...
          if(65 <= c && 90 >= c || 48 <= c && 57 >= c || c == b.SPACE) {
            return
          }
          c = !1;
          for(var f in b) {
      ...
      (c = 32 <= a.charCode ? String.fromCharCode(a.charCode) : a.charCode) || (c = 65 <= a.keyCode && 90 >= a.keyCode || 48 <= a.keyCode && 57 >= a.keyCode || a.keyCode == b.SPACE ? String.fromCharCode(a.keyCode) : a.keyCode);
      c || (c = 229);
      if("keypress" == a.type) {
        if("string" != typeof c) {
          return
      ...
      var d = {faux:!0}, e;
      for(e in a) {
        /^(layer[XY]|returnValue|keyLocation)$/.test(e) || (f = a[e], "function" != typeof f && "undefined" != typeof f && (d[e] = f))
      }
      g.mixin(d, {charOrCode:c, _wasConsumed:!1, preventDefault:function() {
        d._wasConsumed = !0;
        a.preventDefault()
      ...
      d._wasConsumed || this.defer(function() {
        this._onInput(d)
      })
    })), h(this.domNode, "keypress", function(a) {
      a.stopPropagation()
    }))
    ...
    !this.disabled && !this.readOnly && (this.selectOnClick && "mouse" == a && (this._selectOnClickHandle = h.once(this.domNode, "mouseup, touchend", g.hitch(this, function(a) {
  ...
  l("dojo-bidi") && (e = k("dijit.form._TextBoxMixin", e, {_setValueAttr:function() {
    this.inherited(arguments);
  ...
  e._setSelectionRange = m._setSelectionRange = function(a, b, e) {
    a.setSelectionRange && a.setSelectionRange(b, e)
  };
  e.selectInputText = m.selectInputText = function(a, b, f) {
    a = n.byId(a);
    isNaN(b) && (b = 0);
    isNaN(f) && (f = a.value ? a.value.length : 0);
    try {
      a.focus(), e._setSelectionRange(a, b, f)
    }catch(d) {
    }
  };
  return e
