//>>built
define("dijit/_editor/plugins/EnterKeyHandling", "dojo/_base/declare dojo/dom-construct dojo/keys dojo/_base/lang dojo/on dojo/sniff dojo/_base/window dojo/window ../_Plugin ../RichText ../range".split(" "), function(v, n, w, q, u, r, y, s, x, t, k) {
  return v("dijit._editor.plugins.EnterKeyHandling", x, {blockNodeForEnter:"BR", constructor:function(b) {
    ...
    if(this.editor !== b) {
      if(this.editor = b, "BR" == this.blockNodeForEnter) {
        this.editor.customUndo = !0, b.onLoadDeferred.then(q.hitch(this, function(a) {
          this.own(u(b.document, "keydown", q.hitch(this, function(a) {
            if(a.keyCode == w.ENTER) {
              var b = q.mixin({}, a);
              b.shiftKey = !0;
              this.handleEnterKey(b) || (a.stopPropagation(), a.preventDefault())
            }
          })));
          9 <= r("ie") && 10 >= r("ie") && this.own(u(b.document, "paste", q.hitch(this, function(a) {
    ...
    if(this._checkListLater) {
      if(this.editor.selection.isCollapsed()) {
        ...
        if(b) {
          ...
          var a = b.firstChild;
          if(a && 1 == a.nodeType && ("UL" == a.nodeName || "OL" == a.nodeName)) {
            b.insertBefore(a.ownerDocument.createTextNode("\u00a0"), a), a = k.create(this.editor.window), a.setStart(b.firstChild, 0), b = k.getSelection(this.editor.window, !0), b.removeAllRanges(), b.addRange(a)
          }
        }else {
          t.prototype.execCommand.call(this.editor, "formatblock", this.blockNodeForEnter), (b = this.editor.selection.getAncestorElement(this.blockNodeForEnter)) ? (b.innerHTML = this.bogusHtmlContent, 9 >= r("ie") && (b = this.editor.document.selection.createRange(), b.move("character", -1), b.select())) : console.error("onKeyPressed: Cannot find the new block node")
        }
      }
    ...
    if(b.shiftKey) {
      ...
      if(g = k.getAncestor(b, this.blockNodes)) {
        ...
        if(b = k.getSelection(this.editor.window), b.rangeCount) {
          if((a = b.getRangeAt(0)) && a.startContainer) {
            a.collapsed || (a.deleteContents(), b = k.getSelection(this.editor.window), a = b.getRangeAt(0)), (e = a.startContainer) && 3 == e.nodeType ? (g = a.startOffset, e.length < g && (c = this._adjustNodeAndOffset(e, g), e = c.node, g = c.offset), m = e.nodeValue, f = l.createTextNode(m.substring(0, g)), c = l.createTextNode(m.substring(g)), g = l.createElement("br"), c.length || (c = l.createTextNode("\u00a0")), f.length ? n.place(f, e, "after") : f = e, n.place(g, f, "after"), n.place(c, 
            g, "after"), n.destroy(e)) : (0 <= a.startOffset && (d = e.childNodes[a.startOffset]), g = l.createElement("br"), c = l.createTextNode("\u00a0"), d ? (n.place(g, d, "before"), n.place(c, g, "after")) : (e.appendChild(g), e.appendChild(c))), a = k.create(this.editor.window), a.setStart(c, 0), a.setEnd(c, c.length), b.removeAllRanges(), b.addRange(a), this.editor.selection.collapse(!0)
          }
        }else {
          t.prototype.execCommand.call(this.editor, "inserthtml", "\x3cbr\x3e")
        }
      }
      return!1
    }
    ...
    if(k.atEndOfContainer(d.blockNode, p, c)) {
      d.blockNode === d.blockContainer ? d.blockNode.appendChild(h) : n.place(h, d.blockNode, "after"), p = !1, a = k.create(this.editor.window), a.setStart(h, 0), b.removeAllRanges(), b.addRange(a), this.editor.height && s.scrollIntoView(h)
    }else {
      if(k.atBeginningOfContainer(d.blockNode, a.startContainer, a.startOffset)) {
        n.place(h, d.blockNode, d.blockNode === d.blockContainer ? "first" : "before"), h.nextSibling && this.editor.height && (a = k.create(this.editor.window), a.setStart(h.nextSibling, 0), b.removeAllRanges(), b.addRange(a), s.scrollIntoView(h.nextSibling)), p = !1
      }else {
        ...
        if("BR" !== this.blockNodeForEnter) {
          ...
          g && g.parentNode ? (h = g.parentNode, a.setStart(h, 0), b.removeAllRanges(), b.addRange(a), this.editor.height && s.scrollIntoView(h), r("mozilla") && (this._pressedEnterInBlock = d.blockNode)) : p = !0
        }else {
          a.setStart(h, 0), b.removeAllRanges(), b.addRange(a), this.editor.height && s.scrollIntoView(h), r("mozilla") && (this._pressedEnterInBlock = d.blockNode)
        }
      }
    }
    return p
