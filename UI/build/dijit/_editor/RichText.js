//>>built
define("dijit/_editor/RichText", "dojo/_base/array dojo/_base/config dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/_base/kernel dojo/keys dojo/_base/lang dojo/on dojo/query dojo/domReady dojo/sniff dojo/topic dojo/_base/unload dojo/_base/url dojo/window ../_Widget ../_CssStateMixin ../selection ./range ./html ../focus ../main".split(" "), function(r, E, J, F, y, z, G, m, K, v, A, s, k, u, B, L, d, H, M, C, D, 
N, O, P, t, w, I, x) {
  var q = J("dijit._editor.RichText", [N, O], {constructor:function(a) {
  ...
  }, baseClass:"dijitEditor", inheritWidth:!1, focusOnLoad:!1, name:"", styleSheets:"", height:"300px", minHeight:"1em", isClosed:!0, isLoaded:!1, _SEPARATOR:"@@**%%__RICHTEXTBOUNDRY__%%**@@", _NAME_CONTENT_SEP:"@@**%%:%%**@@", onLoadDeferred:null, isTabIndent:!1, disableSpellCheck:!1, postCreate:function() {
    ...
    if(d("ie") || d("trident")) {
      this.contentPostFilters = [this._normalizeFontStyle].concat(this.contentPostFilters), this.contentDomPostFilters = [k.hitch(this, "_stripBreakerNodes")].concat(this.contentDomPostFilters)
    }
    this.contentDomPostFilters = [k.hitch(this, "_stripTrailingEmptyNodes")].concat(this.contentDomPostFilters);
    this.inherited(arguments);
    H.publish(x._scopeName + "._editor.RichText::init", this)
  }, startup:function() {
    this.inherited(arguments);
    this.open();
    ...
    }), b = {b:a("bold"), i:a("italic"), u:a("underline"), a:a("selectall"), s:function() {
      this.save(!0)
    }, m:function() {
      this.isTabIndent = !this.isTabIndent
    }, 1:a("formatblock", "h1"), 2:a("formatblock", "h2"), 3:a("formatblock", "h3"), 4:a("formatblock", "h4"), "\\":a("insertunorderedlist")};
    d("ie") || (b.Z = a("redo"));
    for(var c in b) {
      this.addKeyHandler(c, !0, !1, b[c])
    }
  }, events:["onKeyDown", "onKeyUp"], captureEvents:[], _editorCommandsLocalized:!1, _localizeEditorCommands:function() {
    if(q._editorCommandsLocalized) {
      this._local2NativeFormatNames = q._local2NativeFormatNames, this._native2LocalFormatNames = q._native2LocalFormatNames
    }else {
      q._editorCommandsLocalized = !0;
      q._local2NativeFormatNames = {};
      q._native2LocalFormatNames = {};
      this._local2NativeFormatNames = q._local2NativeFormatNames;
      this._native2LocalFormatNames = q._native2LocalFormatNames;
      for(var a = "div p pre h1 h2 h3 h4 h5 h6 ol ul address".split(" "), b = "", c, f = 0;c = a[f++];) {
        b = "l" !== c.charAt(1) ? b + ("\x3c" + c + "\x3e\x3cspan\x3econtent\x3c/span\x3e\x3c/" + c + "\x3e\x3cbr/\x3e") : b + ("\x3c" + c + "\x3e\x3cli\x3econtent\x3c/li\x3e\x3c/" + c + "\x3e\x3cbr/\x3e")
      }
      var e = m.create("div", {style:{position:"absolute", top:"0px", zIndex:10, opacity:0.01}, innerHTML:b});
    ...
    H.publish(x._scopeName + "._editor.RichText::open", this);
    1 === arguments.length && a.nodeName && (this.domNode = a);
    var b = this.domNode, c;
    if(k.isString(this.value)) {
      c = this.value, b.innerHTML = ""
    }else {
      if(b.nodeName && "textarea" == b.nodeName.toLowerCase()) {
        ...
        var e = k.hitch(this, function() {
          v.set(f, {display:"block", position:"absolute", top:"-1000px"});
          if(d("ie")) {
            var a = f.style;
        ...
        d("ie") ? this.defer(e, 10) : e();
        if(f.form) {
          var p = f.value;
          this.reset = function() {
            this.getValue() !== p && this.replaceValue(p)
          };
          u(f.form, "submit", k.hitch(this, function() {
            z.set(f, "disabled", this.disabled);
            f.value = this.getValue()
          }))
        }
      }else {
        c = w.getChildrenHtml(b), b.innerHTML = ""
      }
    }
    this.value = c;
    ...
    if("" !== this.name && (!E.useXDomain || E.allowXdRichTextSave)) {
      if((c = y.byId(x._scopeName + "._editor.RichText.value")) && "" !== c.value) {
      ...
      q._globalSaveHandler || (q._globalSaveHandler = {}, M.addOnUnload(function() {
        for(var a in q._globalSaveHandler) {
          var b = q._globalSaveHandler[a];
          k.isFunction(b) && b()
        }
      }));
      q._globalSaveHandler[this.id] = k.hitch(this, "_saveContent")
    }
    this.isClosed = !1;
    ...
    c._loadFunc = k.hitch(this, function(a) {
      ...
      this.selection = new P.SelectionManager(a);
    ...
    9 == d("ie") ? (this.editingArea.appendChild(c), c.src = e) : (c.setAttribute("src", e), this.editingArea.appendChild(c));
    ...
    var a = v.getComputedStyle(this.domNode), b = [a.fontWeight, a.fontSize, a.fontFamily].join(" "), c = a.lineHeight, c = 0 <= c.indexOf("px") ? parseFloat(c) / parseFloat(a.fontSize) : 0 <= c.indexOf("em") ? parseFloat(c) : "normal", f = "", e = this;
    this.style.replace(/(^|;)\s*(line-|font-?)[^;]+/ig, function(a) {
      a = a.replace(/^;/ig, "") + ";";
      var b = a.split(":")[0];
      if(b) {
        var b = k.trim(b), b = b.toLowerCase(), c, d = "";
        for(c = 0;c < b.length;c++) {
          var p = b.charAt(c);
          switch(p) {
            case "-":
              c++, p = b.charAt(c).toUpperCase();
            default:
              d += p
          }
        }
    ...
    var a = B('label[for\x3d"' + this.id + '"]'), p = "";
    a.length ? p = a[0].innerHTML : this["aria-label"] ? p = this["aria-label"] : this["aria-labelledby"] && (p = y.byId(this["aria-labelledby"]).innerHTML);
    this.iframe.setAttribute("title", p);
    return["\x3c!DOCTYPE html\x3e", this.isLeftToRight() ? "\x3chtml lang\x3d'" + this.lang + "'\x3e\n\x3chead\x3e\n" : "\x3chtml dir\x3d'rtl' lang\x3d'" + this.lang + "'\x3e\n\x3chead\x3e\n", p ? "\x3ctitle\x3e" + p + "\x3c/title\x3e" : "", "\x3cmeta http-equiv\x3d'Content-Type' content\x3d'text/html'\x3e\n\x3cstyle\x3e\n\tbody,html {\n\t\tbackground:transparent;\n\t\tpadding: 1px 0 0 0;\n\t\tmargin: -1px 0 0 0;\n\t}\n\tbody,html,#dijitEditorBody { outline: none; }html { height: 100%; width: 100%; overflow: hidden; }\n", 
    this.height ? "\tbody,#dijitEditorBody { height: 100%; width: 100%; overflow: auto; }\n" : "\tbody,#dijitEditorBody { min-height: " + this.minHeight + "; width: 100%; overflow-x: auto; overflow-y: hidden; }\n", "\tbody{\n\t\ttop:0px;\n\t\tleft:0px;\n\t\tright:0px;\n\t\tfont:", b, ";\n", this.height || d("opera") ? "" : "\t\tposition: fixed;\n", "\t\tline-height:", c, ";\n\t}\n\tp{ margin: 1em 0; }\n\tli \x3e ul:-moz-first-node, li \x3e ol:-moz-first-node{ padding-top: 1.2em; }\n", d("ie") || 
    d("trident") ? "" : "\tli{ min-height:1.2em; }\n", "\x3c/style\x3e\n", this._applyEditingAreaStyleSheets(), "\n\x3c/head\x3e\n\x3cbody role\x3d'main' ", "onload\x3d'try{frameElement \x26\x26 frameElement._loadFunc(window,document)}catch(e){document.domain\x3d\"" + document.domain + "\";frameElement._loadFunc(window,document)}' ", "style\x3d'" + f + "'\x3e", "\x3cdiv id\x3d'dijitEditorBody'\x3e\x3c/div\x3e\x3c/body\x3e\n\x3c/html\x3e"].join("")
  }, _applyEditingAreaStyleSheets:function() {
    var a = [];
    this.styleSheets && (a = this.styleSheets.split(";"), this.styleSheets = "");
    a = a.concat(this.editingAreaStyleSheets);
    this.editingAreaStyleSheets = [];
    for(var b = "", c = 0, f, e = D.get(this.ownerDocument);f = a[c++];) {
      f = (new C(e.location, f)).toString(), this.editingAreaStyleSheets.push(f), b += '\x3clink rel\x3d"stylesheet" type\x3d"text/css" href\x3d"' + f + '"/\x3e'
    }
    return b
  }, addStyleSheet:function(a) {
    var b = a.toString(), c = D.get(this.ownerDocument);
    if("." === b.charAt(0) || "/" !== b.charAt(0) && !a.host) {
      b = (new C(c.location, b)).toString()
    }
    -1 < r.indexOf(this.editingAreaStyleSheets, b) || (this.editingAreaStyleSheets.push(b), this.onLoadDeferred.then(k.hitch(this, function() {
      if(this.document.createStyleSheet) {
        this.document.createStyleSheet(b)
      }else {
        var a = this.document.getElementsByTagName("head")[0], c = this.document.createElement("link");
        c.rel = "stylesheet";
        c.type = "text/css";
        c.href = b;
        a.appendChild(c)
    ...
    -1 !== a && (delete this.editingAreaStyleSheets[a], B('link[href\x3d"' + b + '"]', this.window.document).orphan())
  }, disabled:!1, _mozSettingProps:{styleWithCSS:!1}, _setDisabledAttr:function(a) {
    a = !!a;
    ...
    this.window.__registeredWindow || (this.window.__registeredWindow = !0, this._iframeRegHandle = I.registerIframe(this.iframe));
    ...
    var c = this.events.concat(this.captureEvents), f = this.iframe ? this.document : this.editNode;
    this.own.apply(this, r.map(c, function(a) {
      var b = a.toLowerCase().replace(/^on/, "");
      return u(f, b, k.hitch(this, a))
    }, this));
    this.own(u(f, "mouseup", k.hitch(this, "onClick")));
    d("ie") && (this.own(u(this.document, "mousedown", k.hitch(this, "_onIEMouseDown"))), this.editNode.style.zoom = 1);
    d("webkit") && (this._webkitListener = this.own(u(this.document, "mouseup", k.hitch(this, "onDisplayChanged")))[0], this.own(u(this.document, "mousedown", k.hitch(this, function(a) {
    ...
    c = k.hitch(this, function() {
      ...
      this.focusOnLoad && L(k.hitch(this, "defer", "focus", this.updateInterval));
      this.value = this.getValue(!0)
    });
    this.setValueDeferred ? this.setValueDeferred.then(c) : c()
  }, onKeyDown:function(a) {
    if(a.keyCode === s.SHIFT || a.keyCode === s.ALT || a.keyCode === s.META || a.keyCode === s.CTRL) {
      return!0
    }
    if(a.keyCode === s.TAB && this.isTabIndent && (a.stopPropagation(), a.preventDefault(), this.queryCommandEnabled(a.shiftKey ? "outdent" : "indent"))) {
      this.execCommand(a.shiftKey ? "outdent" : "indent")
    }
    if(a.keyCode == s.TAB && !this.isTabIndent && !a.ctrlKey && !a.altKey) {
      return a.shiftKey ? this.beforeIframeNode.focus() : this.afterIframeNode.focus(), !0
    }
    9 > d("ie") && (a.keyCode === s.BACKSPACE && "Control" === this.document.selection.type) && (a.stopPropagation(), a.preventDefault(), this.execCommand("delete"));
    d("ff") && (a.keyCode === s.PAGE_UP || a.keyCode === s.PAGE_DOWN) && this.editNode.clientHeight >= this.editNode.scrollHeight && a.preventDefault();
    var b = this._keyHandlers[a.keyCode], c = arguments;
    b && !a.altKey && r.some(b, function(b) {
    ...
    A.deprecated("dijit.Editor::setDisabled is deprecated", 'use dijit.Editor::attr("disabled",boolean) instead', 2);
    this.set("disabled", a)
  }, _setValueAttr:function(a) {
    this.setValue(a)
  }, _setDisableSpellCheckAttr:function(a) {
    this.document ? z.set(this.document.body, "spellcheck", !a) : this.onLoadDeferred.then(k.hitch(this, function() {
      z.set(this.document.body, "spellcheck", !a)
    }));
    ...
    this._keyHandlers[a].push({shift:c || !1, ctrl:b || !1, handler:f})
    ...
    (d("ie") || d("trident")) && this.defer(function() {
      I.curNode || this.ownerDocumentBody.focus()
    });
    this.inherited(arguments);
    ...
    return c
  }, _qcaCache:{}, queryCommandAvailable:function(a) {
    var b = this._qcaCache[a];
    return void 0 !== b ? b : this._qcaCache[a] = this._queryCommandAvailable(a)
  }, _queryCommandAvailable:function(a) {
    function b(a) {
      return{ie:Boolean(a & c), mozilla:Boolean(a & f), webkit:Boolean(a & e), opera:Boolean(a & p)}
    }
    var c = 1, f = 2, e = 4, p = 8, g = null;
    ...
    return(d("ie") || d("trident")) && g.ie || d("mozilla") && g.mozilla || d("webkit") && g.webkit || d("opera") && g.opera
    ...
    if(void 0 !== b) {
      ...
      if("formatblock" === a && (d("ie") || d("trident"))) {
        b = "\x3c" + b + "\x3e"
      }
    }
    var f = "_" + a + "Impl";
    if(this[f]) {
      ...
      if((b = 1 < arguments.length ? b : null) || "createlink" !== a) {
    ...
    if(d("mozilla")) {
      for(var b = this.editNode.firstChild;b;) {
        if(3 === b.nodeType) {
          ...
          if(1 === b.nodeType) {
            var a = !0, c = b.tagName ? b.tagName.toLowerCase() : "";
      ...
      a = !0, this.selection.selectElementChildren(this.editNode)
    }
    ...
    var c;
    k.isString(a) ? c = a : (a = a || this.editNode, this.contentDomPostFilters.length && (b && (a = k.clone(a)), r.forEach(this.contentDomPostFilters, function(b) {
      a = b(a)
    })), c = w.getChildrenHtml(a));
    ...
    var a = y.byId(x._scopeName + "._editor.RichText.value");
    ...
    A.deprecated("dijit.Editor::getNodeHtml is deprecated", "use dijit/_editor/html::getNodeHtml instead", 2);
    return w.getNodeHtml(a)
  }, getNodeChildrenHtml:function(a) {
    A.deprecated("dijit.Editor::getNodeChildrenHtml is deprecated", "use dijit/_editor/html::getChildrenHtml instead", 2);
    return w.getChildrenHtml(a)
  }, close:function(a) {
    if(!this.isClosed) {
      ...
      this._iframeRegHandle && (this._iframeRegHandle.remove(), delete this._iframeRegHandle);
      if(this.textarea) {
    ...
    this._updateTimer && this._updateTimer.remove();
    this.inherited(arguments);
    q._globalSaveHandler && delete q._globalSaveHandler[this.id]
    ...
    var b;
    this._handleTextColorOrProperties("hilitecolor", a) || (d("mozilla") ? (this.document.execCommand("styleWithCSS", !1, !0), b = this.document.execCommand("hilitecolor", !1, a), this.document.execCommand("styleWithCSS", !1, !1)) : b = this.document.execCommand("hilitecolor", !1, a));
    return b
    ...
    if(9 > d("ie")) {
      ...
      if(8 > d("trident")) {
        ...
        if(e && e.rangeCount && e.getRangeAt) {
          ...
          var p = m.create("div");
          p.innerHTML = a;
          for(var g, f = this.document.createDocumentFragment();a = p.firstChild;) {
            g = f.appendChild(a)
          }
          c.insertNode(f);
        ...
        d("mozilla") && !a.length ? this.selection.remove() : b = this.document.execCommand("inserthtml", !1, a)
      }
    }
    return b
    ...
    var b = !1;
    if(d("ie") || d("trident")) {
      this._adaptIESelection(), b = this._adaptIEFormatAreaAndExec("bold")
    }
    ...
    var b = !1;
    if(d("ie") || d("trident")) {
      this._adaptIESelection(), b = this._adaptIEFormatAreaAndExec("italic")
    }
    ...
    var b = !1;
    if(d("ie") || d("trident")) {
      this._adaptIESelection(), b = this._adaptIEFormatAreaAndExec("underline")
    }
    ...
    var b = !1;
    if(d("ie") || d("trident")) {
      this._adaptIESelection(), b = this._adaptIEFormatAreaAndExec("strikethrough")
    }
    ...
    var b = !1;
    if(d("ie") || d("trident")) {
      this._adaptIESelection(), b = this._adaptIEFormatAreaAndExec("superscript")
    }
    ...
    var b = !1;
    if(d("ie") || d("trident")) {
      this._adaptIESelection(), b = this._adaptIEFormatAreaAndExec("subscript")
    }
    ...
    if(a && a.childNodes) {
      ...
      for(c = 0;c < a.childNodes.length;c++) {
        var f = K.position(a.childNodes[c]), b = b + f.h
      }
    }
    return b
    ...
    if(a && a.rangeCount && !a.isCollapsed) {
      for(var b = a.getRangeAt(0), c = b.startContainer, f = b.startOffset;3 === c.nodeType && f >= c.length && c.nextSibling;) {
        f -= c.length, c = c.nextSibling
      }
      for(var e = null;this._isNodeEmpty(c, f) && c !== e;) {
        e = c, b = this._removeStartingRangeFromRange(c, b), c = b.startContainer, f = 0
      }
      a.removeAllRanges();
      a.addRange(b)
    }
  }, _adaptIEFormatAreaAndExec:function(a) {
    var b = t.getSelection(this.window), c = this.document, f, e, d, g, h, l, n;
    if(a && b && b.isCollapsed) {
      if(this.queryCommandValue(a)) {
        a = this._tagNamesForCommand(a);
        d = b.getRangeAt(0);
        g = d.startContainer;
        3 === g.nodeType && (e = d.endOffset, g.length < e && (e = this._adjustNodeAndOffset(f, e), g = e.node));
        ...
        if(n && (f = d.startContainer, a = c.createElement(n.tagName), m.place(a, n, "after"), f && 3 === f.nodeType)) {
          ...
          for(f = [];d !== n;) {
            ...
            f.push(e);
            g = c.createElement(g);
            d.style && (g.style && d.style.cssText) && (g.style.cssText = d.style.cssText, e.cssText = d.style.cssText);
            "FONT" === d.tagName && (d.color && (g.color = d.color, e.color = d.color), d.face && (g.face = d.face, e.face = d.face), d.size && (g.size = d.size, e.size = d.size));
            d.className && (g.className = d.className, e.className = d.className);
            if(h) {
              for(;h;) {
                e = h.nextSibling, g.appendChild(h), h = e
              }
            }
            g.tagName == d.tagName ? (l = c.createElement("span"), l.className = "ieFormatBreakerSpan", m.place(l, d, "after"), m.place(g, l, "after")) : m.place(g, d, "after");
            h = g;
            d = d.parentNode
          }
          if(h) {
            ...
            for(;h;) {
              e = h.nextSibling, a.appendChild(h), h = e
            }
          }
          if(f.length) {
            e = f.pop();
            h = c.createElement(e.tagName);
            e.cssText && h.style && (h.style.cssText = e.cssText);
            e.className && (h.className = e.className);
            "FONT" === e.tagName && (e.color && (h.color = e.color), e.face && (h.face = e.face), e.size && (h.size = e.size));
            for(m.place(h, a, "before");f.length;) {
              e = f.pop(), n = c.createElement(e.tagName), e.cssText && n.style && (n.style.cssText = e.cssText), e.className && (n.className = e.className), "FONT" === e.tagName && (e.color && (n.color = e.color), e.face && (n.face = e.face), e.size && (n.size = e.size)), h.appendChild(n), h = n
            }
            n = c.createTextNode(".");
            l.appendChild(n);
            h.appendChild(n)
          }else {
            l = c.createElement("span"), l.className = "ieFormatBreakerSpan", n = c.createTextNode("."), l.appendChild(n), m.place(l, a, "before")
          }
      ...
      d = b.getRangeAt(0);
      if((f = d.startContainer) && 3 === f.nodeType) {
        return e = d.startOffset, f.length < e && (e = this._adjustNodeAndOffset(f, e), f = e.node, e = e.offset), g = f.nodeValue, d = c.createTextNode(g.substring(0, e)), k = g.substring(e), "" !== k && (h = c.createTextNode(g.substring(e))), l = c.createElement("span"), n = c.createTextNode("."), l.appendChild(n), d.length ? m.place(d, f, "after") : d = f, m.place(l, d, "after"), h && m.place(h, l, "after"), m.destroy(f), h = t.create(this.window), h.setStart(n, 0), h.setEnd(n, n.length), b.removeAllRanges(), 
        b.addRange(h), c.execCommand(a), m.place(l.firstChild, l, "before"), m.destroy(l), h.setStart(n, 0), h.setEnd(n, n.length), b.removeAllRanges(), b.addRange(h), this.selection.collapse(!1), n.parentNode.innerHTML = "", !0
      }
    }else {
      return!1
    }
    ...
    if(b.isCollapsed && b.rangeCount && !this.queryCommandValue(a)) {
      ...
      if(d && 3 == d.nodeType && !c.startOffset) {
        return c = "ul", "insertorderedlist" === a && (c = "ol"), a = this.document.createElement(c), c = m.create("li", null, a), m.place(a, d, "before"), c.appendChild(d), m.create("br", null, a, "after"), a = t.create(this.window), a.setStart(d, 0), a.setEnd(d, d.length), b.removeAllRanges(), b.addRange(a), this.selection.collapse(!0), !0
      }
    }
    return!1
  }, _handleTextColorOrProperties:function(a, b) {
    var c = t.getSelection(this.window), f = this.document, e, k, g, h, l;
    b = b || null;
    if(a && (c && c.isCollapsed) && c.rangeCount && (k = c.getRangeAt(0), (e = k.startContainer) && 3 === e.nodeType)) {
      l = k.startOffset;
      e.length < l && (k = this._adjustNodeAndOffset(e, l), e = k.node, l = k.offset);
      g = e.nodeValue;
      ...
      if(d("webkit")) {
        ...
        this.execCommand(a, b), m.place(g.firstChild, g, "before"), m.destroy(g), e.setStart(l, 0), e.setEnd(l, l.length), c.removeAllRanges(), c.addRange(e), this.selection.collapse(!1), l.parentNode.removeChild(l)
      }
      return!0
    }
    return!1
    ...
    if(this.isLoaded) {
      return B(".ieFormatBreakerSpan", a).forEach(function(a) {
        for(;a.firstChild;) {
          m.place(a.firstChild, a, "before")
        }
        m.destroy(a)
      }), a
    }
  }, _stripTrailingEmptyNodes:function(a) {
    for(;a.lastChild && (/^(p|div|br)$/i.test(a.lastChild.nodeName) && 0 == a.lastChild.children.length && /^[\s\xA0]*$/.test(a.lastChild.textContent || a.lastChild.innerText || "") || 3 === a.lastChild.nodeType && /^[\s\xA0]*$/.test(a.lastChild.nodeValue));) {
      m.destroy(a.lastChild)
    }
    return a
