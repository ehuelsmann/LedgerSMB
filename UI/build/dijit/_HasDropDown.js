//>>built
define("dijit/_HasDropDown", "dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/has dojo/keys dojo/_base/lang dojo/on dojo/touch ./registry ./focus ./popup ./_FocusMixin".split(" "), function(q, r, u, l, h, m, v, w, k, f, g, n, s, x, p, t) {
  return q("dijit._HasDropDown", t, {_buttonNode:null, _arrowWrapperNode:null, _popupStateNode:null, _aroundNode:null, dropDown:null, autoWidth:!0, forceWidth:!1, maxHeight:-1, dropDownPosition:["below", "above"], _stopClickEvents:!0, _onDropDownMouseDown:function(a) {
    !this.disabled && !this.readOnly && ("MSPointerDown" != a.type && "pointerdown" != a.type && a.preventDefault(), this.own(g.once(this.ownerDocument, n.release, f.hitch(this, "_onDropDownMouseUp"))), this.toggleDropDown())
    ...
    if(a && this._opened) {
      ...
      if(!(a.pageX >= b.x && a.pageX <= b.x + b.w) || !(a.pageY >= b.y && a.pageY <= b.y + b.h)) {
        for(b = a.target;b && !d;) {
          h.contains(b, "dijitPopup") ? d = !0 : b = b.parentNode
        }
        if(d) {
          b = a.target;
          if(c.onItemClick) {
            for(var e;b && !(e = s.byNode(b));) {
              b = b.parentNode
            }
            if(e && e.onClick && e.getParent) {
              e.getParent().onItemClick(e, a)
            }
          }
          return
        }
    ...
    this.own(g(this._buttonNode, n.press, f.hitch(this, "_onDropDownMouseDown")), g(this._buttonNode, "click", f.hitch(this, "_onDropDownClick")), g(a, "keydown", f.hitch(this, "_onKey")), g(a, "keyup", f.hitch(this, "_onKeyUp")))
  }, destroy:function() {
    ...
    if(!this.disabled && !this.readOnly) {
      ...
      if(c && (this._opened && c.handleKey) && !1 === c.handleKey(a)) {
        ...
        if(c && this._opened && a.keyCode == k.ESCAPE) {
          this.closeDropDown(), a.stopPropagation(), a.preventDefault()
        }else {
          if(!this._opened && (a.keyCode == k.DOWN_ARROW || (a.keyCode == k.ENTER || a.keyCode == k.SPACE && (!this._searchTimer || a.ctrlKey || a.altKey || a.metaKey)) && ("input" !== (d.tagName || "").toLowerCase() || d.type && "text" !== d.type.toLowerCase()))) {
    ...
    var a = new r, c = f.hitch(this, function() {
      this.openDropDown();
    ...
    var a = this.dropDown, c = a.domNode, d = this._aroundNode || this.domNode, b = this, e = p.open({parent:this, popup:a, around:d, orient:this.dropDownPosition, maxHeight:this.maxHeight, onExecute:function() {
      b.closeDropDown(!0)
    }, onCancel:function() {
      b.closeDropDown(!0)
    }, onClose:function() {
    ...
    if(this.forceWidth || this.autoWidth && d.offsetWidth > a._popupWrapper.offsetWidth) {
      var d = d.offsetWidth - a._popupWrapper.offsetWidth, g = {w:a.domNode.offsetWidth + d};
